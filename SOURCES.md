...
- **Nixle disposition:** documented but NOT scraped (third-party notification platform — same gap policy PLAN sets for social channels). Groundwork for a future revisit (permalink pattern, timestamps, pagination, ~1 message per 1-2 weeks cadence) is recorded in reports/notes/sbsheriff-news.md.
