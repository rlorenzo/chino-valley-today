...
case "$group" in
	...
	daily)
		keys=(chino-legistar chino-agendacenter chinohills-agendas cvusd-board abc-licenses sbclib-events sbparks-events cbwcd-events yanksair-events chinohigh-sports ayala-sports donlugo-sports chinohills-sports)
		;;
