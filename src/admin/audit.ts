...
export function isSampledForAudit(slug: string, isoWeek: string, rate: number = AUDIT_RATE): boolean {
...
export function rollingFailCounts(db: Db, days: number = 30): Map<string, number> {
